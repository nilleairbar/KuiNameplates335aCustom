...
local mod = addon:NewModule("ThreatMode", addon.Prototype, "AceEvent-3.0")
local L = LibStub("AceLocale-3.0"):GetLocale("KuiNameplates")

local class, threatmode = select(2, UnitClass("player")), nil

local profile_threatmode

mod.uiName = L["Threat"]

-------------------------------------------------------- threat bracket stuff --
local function ShowThreatTracker(frame, ...)
